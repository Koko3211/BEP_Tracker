...
from tracker.our_sort import OurSort, KalmanBoxTracker
#Changeable
TRACKER_NAME = "sort_ours"
SPLIT = "MFT-test"
...
def run_tracking(seq_dir):
    ...
    tracker= OurSort(max_age=40, min_hits=3, birth_iou_thresh=0.6, birth_min_conf=0.35, iou_h=0.6, iou_l = 0.25,
                      decay_rate = 0.075, IoUW=0.7, areaW=0.2, slipW=0.1, slip_decay=0.1, det_min_conf=0.20, sim = "fishsim")
