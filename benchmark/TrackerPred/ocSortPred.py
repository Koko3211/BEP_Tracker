...
#import sort
from OC_SORT.trackers.ocsort_tracker.ocsort import OCSort, KalmanBoxTracker
...
def run_tracking(seq_dir):
    ...
    tracker= OCSort(det_thresh = 0.5, max_age=60, min_hits=3, iou_threshold=0.3, delta_t=3, asso_func="iou", inertia=0.2, use_byte=True)
